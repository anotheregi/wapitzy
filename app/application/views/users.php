                                            ...
                                            <tbody>
                                                <?php foreach ($users->result() as $d) : ?>
                                                    <tr>
                                                        ...
                                                        <td><?= ($d->expired == null) ? 'Lifetime' : date('m-d-Y', strtotime($d->expired)) ?></td>
                ...
                <form method="post">
                    <div class="modal-body">
                        ...
                        <div id="input_tujuan">
                            ...
                            <input type="date" name="expired" required id="expired" class="form-control">
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" id="lifetime" type="checkbox" name="lifetime">
